# peggy-intellij-plugin

![Build](https://github.com/mliebelt/peggy-intellij-plugin/workflows/Build/badge.svg)
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "peggy-intellij-plugin"</kbd> >
  <kbd>Install</kbd>
  
- Manually:

  Download the [latest release](https://github.com/mliebelt/peggy-intellij-plugin/releases/latest) and install it manually using
